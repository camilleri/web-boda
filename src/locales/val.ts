const val = {
  translation: {
    ...
    transport_message:
      "Hi haurà servei de transport en autobús fins al lloc de l'esdeveniment. Si us plau, fes-nos saber si aniràs amb bus al formulari per valorar les parades.",
